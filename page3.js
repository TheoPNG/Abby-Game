    ...
    for (let i = 0; i < h; i++) {
        ...
        if (!letter.includes(activeChoice)) {
            ...
            if(list[i].className.includes("b1")) {
                list[i].style.setProperty("--new-bg-image", 'url("./photos/row-3-column-1.png")');
            }
            else if(list[i].className.includes("b2")) {
                list[i].style.setProperty("--new-bg-image", 'url("./photos/row-3-column-2.png")');
            }
            else if(list[i].className.includes("b3")) {
                list[i].style.setProperty("--new-bg-image", 'url("./photos/row-3-column-3.png")');
            }
            else if(list[i].className.includes("b4")) {
                list[i].style.setProperty("--new-bg-image", 'url("./photos/row-3-column-4.png")');
            }
            else if(list[i].className.includes("b5")) {
                list[i].style.setProperty("--new-bg-image", 'url("./photos/row-3-column-5.png")');
            }
            else if(list[i].className.includes("b6")) {
                list[i].style.setProperty("--new-bg-image", 'url("./photos/row-3-column-6.png")');
            }
...
async function win() {
    ...
    for (box of document.getElementById('row1').children){
        if(box.className.includes("b1")) {
           box.style.setProperty("--new-bg-image", 'url("./photos/row-3-column-1.png")');
        }
        else if(box.className.includes("b2")) {
             box.style.setProperty("--new-bg-image", 'url("./photos/row-3-column-2.png")');
        }
        else if(box.className.includes("b3")) {
            box.style.setProperty("--new-bg-image", 'url("./photos/row-3-column-3.png")');
        }
        else if(box.className.includes("b4")) {
            box.style.setProperty("--new-bg-image", 'url("./photos/row-3-column-4.png")');
        }
        else if(box.className.includes("b5")) {
            box.style.setProperty("--new-bg-image", 'url("./photos/row-3-column-5.png")');
        }
        else if(box.className.includes("b6")) {
            box.style.setProperty("--new-bg-image", 'url("./photos/row-3-column-6.png")');
        }
        await sleep(100);
